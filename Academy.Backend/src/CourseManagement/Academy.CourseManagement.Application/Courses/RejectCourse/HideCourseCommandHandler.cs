...
{
    public class RejectCourseCommandHandler : ICommandHandler<Guid, RejectCourseCommand>
    {
        private readonly ICoursesRepository _coursesRepository;

        public RejectCourseCommandHandler(ICoursesRepository coursesRepository)
        {
            _coursesRepository = coursesRepository;
        }

        public async Task<Result<Guid, ErrorList>> Handle(RejectCourseCommand command, CancellationToken cancellationToken = default)
        {
